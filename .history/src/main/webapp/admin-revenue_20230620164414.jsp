            ...
            <ul class="metismenu" id="menu1">
              <li>
                <a class="has-arrow" href="#">
                  ...
                  <span class="mini-click-non">Manage Revenue</span>
                </a>
                <ul class="submenu-angle" aria-expanded="true">
                  <li>
                    <a title="Product List" href="#"><span class="mini-sub-pro">Dashboard</span></a>
                  </li>
                </ul>
              </li>
              <li>
                <a class="has-arrow" href="#">
                  ...
                  <span class="mini-click-non">Manage Products</span>
                </a>
                <ul class="submenu-angle" aria-expanded="true">
                  <li>
                    <a title="Product List" href="admin-product-list.html"
              ...
              <li>
                <a class="has-arrow" href="#">
                  ...
                  <span class="mini-click-non">Manage HR</span>
                </a>
                <ul class="submenu-angle" aria-expanded="true">
                  <li>
                    <a title="Product List" href="#"><span class="mini-sub-pro">Emplyee List</span></a>
                  </li>
                  <li>
                    <a title="Product List" href="#"><span class="mini-sub-pro">Add Employee</span></a>
                  </li>
                </ul>
              </li>
              <li>
                <a class="has-arrow" href="#">
                  ...
                  <span class="mini-click-non">Manage Order</span>
                </a>
                <ul class="submenu-angle" aria-expanded="true">
                  <li>
                    <a title="Product List" href="#"><span class="mini-sub-pro">Shipping List</span></a>
                  </li>
                  <li>
                    <a title="Product List" href="#"><span class="mini-sub-pro">Delivery List</span></a>
                  </li>
                </ul>
              </li>
              <li>
                <a class="" href="#">
                  ...
                  <span class="mini-click-non">Manage Customers</span>
                </a>
              </li>
              <li>
                <a class="" href="#">
                  <i class="icon nalika-cloud icon-wrap"></i>
                  <span class="mini-click-non">Manage Coupons</span>
                </a>
              </li>
            </ul>
          </nav>
                            ...
                            <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                              ...
                              <li>
                                <a
                                  href="
                                #"
                                  ><span class="icon nalika-unlocked author-log-ic"></span> Log Out</a
                                >
                              </li>
                            </ul>
                          </li>
                    ...
                    <ul class="mobile-menu-nav">
                      <li>
                        <a data-toggle="collapse" data-target="#Charts" href="#"
                          >Manage Revenue <span class="admin-project-icon nalika-icon nalika-down-arrow"></span
                        ></a>
                      ...
                      <li>
                        <a data-toggle="collapse" data-target="#Charts" href="#"
                          >Manage Products <span class="admin-project-icon nalika-icon nalika-down-arrow"></span
                        ></a>
                        <ul class="collapse dropdown-header-top">
                      ...
                      <li>
                        <a data-toggle="collapse" data-target="#Charts" href="#"
                          >Manage HR <span class="admin-project-icon nalika-icon nalika-down-arrow"></span
                        ></a>
                        <ul class="collapse dropdown-header-top">
                      ...
                      <li>
                        <a data-toggle="collapse" data-target="#Charts" href="#"
                          >Manage Order <span class="admin-project-icon nalika-icon nalika-down-arrow"></span
                        ></a>
                        <ul class="collapse dropdown-header-top">
                      ...
                      <li>
                        <a data-toggle="collapse" data-target="#Charts" href="#"
                          >Manage Customers<span class="admin-project-icon nalika-icon"></span
                        ></a>
                      </li>
                      <li>
                        <a data-toggle="collapse" data-target="#Charts" href="#"
                          >Manage Coupon<span class="admin-project-icon nalika-icon"></span
                        ></a>
                      </li>
                    </ul>
                  </nav>
        ...
        <div class="single-pro-review-area">
          <div class="container-fluid">
            <div class="row">
              ...
              <div><img src="chart" alt="Sample Chart" /></div>
            </div>
          </div>
        </div>
      </div>
