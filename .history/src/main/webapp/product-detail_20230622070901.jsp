          ...
          <nav class="sidebar-nav left-sidebar-menu-pro">
            ...
            <ul class="metismenu" id="menu1">
              ...
              <li>
                ...
                <ul class="submenu-angle" aria-expanded="true">
                  <li>
                    <a title="Product List" href="product-list.html"><span
                        class="mini-sub-pro">Products List</span></a>
                  </li>
                  <li>
                    <a title="Product List" href="#"><span class="mini-sub-pro">Add
                        Product</span></a>
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul class="submenu-angle" aria-expanded="true">
                  <li>
                    <a title="Product List" href="#"><span class="mini-sub-pro">Emplyee
                        List</span></a>
                  </li>
                  <li>
                    <a title="Product List" href="#"><span class="mini-sub-pro">Add
              ...
              <li>
                ...
                <ul class="submenu-angle" aria-expanded="true">
                  <li>
                    <a title="Product List" href="#"><span class="mini-sub-pro">Shipping
                        List</span></a>
                  </li>
                  <li>
                    <a title="Product List" href="#"><span class="mini-sub-pro">Delivery
                        List</span></a>
                  </li>
                </ul>
              </li>
                ...
                <div class="mobile-menu">
                  <nav id="dropdown">
                    <ul class="mobile-menu-nav">
                      <li>
                        <a data-toggle="collapse" data-target="#Charts" href="#">Manage
                          Revenue <span
                      ...
                      <li>
                        <a data-toggle="collapse" data-target="#Charts" href="#">Manage
                          Customers<span class="admin-project-icon nalika-icon"></span></a>
                      </li>
                      <li>
                        <a data-toggle="collapse" data-target="#Charts" href="#">Manage
                          Coupon<span class="admin-project-icon nalika-icon"></span></a>
                      </li>
                    </ul>
                  </nav>
                </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="footer-copy-right">
                <p>
                  Copyright © 2023 <a
                    href="https://www.facebook.com/hipsterstore">Hipsterstore</a>
                  All rights reserved.
                </p>
=======
=======
