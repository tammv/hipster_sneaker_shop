              ...
              <div class="block2">
                ...
                <div class="block2-txt flex-w flex-t p-t-14">
                  <div class="block2-txt-child1 flex-col-l">
                    <a href="product-detail.jsp?product_id=${product.product_id}&profit_price=${product.profit_price}&product_description=${product.prouduct_description}&img=${product.img}&product_name=${product.product_name}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
