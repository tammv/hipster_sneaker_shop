        ...
        <div class="row">
            ...
            <form action="updateCart" method="post">
              <div class="m-l-25 m-r--38 m-lr-0-xl">
                  ...
                  <table class="table-shopping-cart">
                    ...
                    <c:forEach items="${sessionScope.cart_user.list_product}" var="productCart">
                      <tr class="table_row">
                        ...
                        <td class="column-3">
                          <select
                            class="w-75 sizeTable"
                            name="${productCart.product.product_id}size${productCart.size}"
                            id=""
                          >
                ...
                <div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
                  ...
                  <button
                    type="submit"
                    class="flex-c-m stext-101 cl2 size-119 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-10 updateToCart"
                  >
                    Update To Cart
                  </button>
                </div>
          ...
          <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50 cartTotal">
            <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
              ...
              <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                ...
                <div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
                  ...
                  <div class="p-t-15">
                    ...
                    <textarea
                      class="form-control m-b-9 address"
                      rows="5"
                      placeholder="Address"
                      name="address"
                    ></textarea>
                    <div class="flex-w">
                      <button
                        class="flex-c-m stext-101 cl2 size-115 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer updateTotal"
                      >
                        Update Totals
                      </button>
                    </div>
              ...
              <a
                href=""
                class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer proceedToCheckout"
              >
                Proceed to Checkout
              </a>
            </div>
